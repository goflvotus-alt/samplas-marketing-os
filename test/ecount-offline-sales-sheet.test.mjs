...
async function workbookFixture(sheets) {
  ...
  for (const [index, sheet] of sheets.entries()) {
    ...
    await writeFile(join(xl, "worksheets", `sheet${index + 1}.xml`), `<worksheet><sheetData>
      ...
      <row><c r="A2" t="inlineStr"><is><t>2026/08/13 -2</t></is></c><c r="B2" t="inlineStr"><is><t>${xml(sheet.productName || "TEST PRODUCT")}</t></is></c><c r="C2" t="inlineStr"><is><t>OS</t></is></c><c r="D2"><v>1</v></c><c r="E2" t="inlineStr"><is><t>${xml(sheet.brandGroup || "TEST")}</t></is></c><c r="F2" t="inlineStr"><is><t>성진님</t></is></c><c r="G2" t="inlineStr"><is><t>PO-1</t></is></c><c r="H2"><v>${sheet.amount}</v></c>${warehouseCell}</row>${summaryRows}
    </sheetData></worksheet>`);
  }
